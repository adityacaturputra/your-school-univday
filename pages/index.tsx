      ...
      <div className={`h-screen bg-black ${QtaClicked ? 'bg-opacity-0' : 'bg-opacity-80'} flex flex-col lg:justify-center md:justify-center justify-evenly transition duration-1000`}>
        ...
        <>
          ...
          <div className="text-center mt-10">
            <button className="w-auto hover:text-purple-600 text-purple-300 p-2 border-b-2 hover:border-purple-600 bg-purple-200 rounded bg-opacity-30 hover:bg-opacity-100 text-2xl transition duration-500 ease-in-out shadow-inner" onClick={ () => {setQtaClicked(true); setTimeout(() => router.replace('/explore'), 900);} }>Explore your favorite now</button>
          </div>
        </>
        }
      </div>
